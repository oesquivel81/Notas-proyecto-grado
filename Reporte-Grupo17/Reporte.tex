...
\begin{tabular}{cc}
\subfloat[Distribución de imágenes por split]{\includegraphics[width=0.45\linewidth]{analysis/figures/split_distribution.png}} &
\subfloat[Dispersión de resoluciones (ancho vs alto)]{\includegraphics[width=0.45\linewidth]{analysis/figures/resolution_scatter.png}}
\end{tabular}

\caption{Diagnóstico exploratorio del dataset. Se observa desbalance entre clases (Normal/Scoliosis) y alta variabilidad en resolución, lo cual justifica estrategias de preprocesamiento y partición cuidadosa por paciente.}
...
\begin{tabular}{cc}
\subfloat[Histograma del ángulo de Cobb]{\includegraphics[width=0.45\linewidth]{analysis/figures/cobb_histogram.png}} &
\subfloat[Boxplot del ángulo de Cobb]{\includegraphics[width=0.45\linewidth]{analysis/figures/cobb_boxplot.png}}
\end{tabular}

\caption{Distribución de la severidad clínica en el subconjunto Scoliosis. La concentración de casos en rangos altos de Cobb sugiere un dataset sesgado hacia deformidades severas, aspecto que debe considerarse en la interpretación del desempeño del modelo.}

\label{fig:eda_cobb_distribution}
