...
\begin{enumerate}[leftmargin=0.8cm,label=\arabic*.,itemsep=1.0em]
    ...
    \item \textbf{Transparencia y trazabilidad:} Dada la naturaleza de "caja negra" de las redes neuronales profundas, la arquitectura propuesta incorpora Análisis Topológico de Datos (TDA) y geometría diferencial para aportar una capa de interpretabilidad estructural.
    \begin{itemize}
