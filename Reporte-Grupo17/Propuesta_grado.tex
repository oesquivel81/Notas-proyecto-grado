...
\begin{enumerate}[leftmargin=0.8cm,label=\arabic*.,itemsep=1.0em]
    ...
    \begin{itemize}[leftmargin=0.6cm]
        ...
        \item \textbf{Impacto social:} la herramienta se plantea como apoyo a decisión clínica, no como sustituto del criterio médico.
        \item \textbf{Transparencia y trazabilidad:} registro de experimentos, configuración de modelos y métricas para auditoría técnica.
    \end{itemize}
