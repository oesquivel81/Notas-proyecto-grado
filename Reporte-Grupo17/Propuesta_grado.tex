...
\begin{enumerate}[leftmargin=0.8cm,label=\arabic*.,itemsep=1.0em]
    ...
    \begin{itemize}[leftmargin=0.6cm]
        \item \textbf{Privacidad:} trabajo con datos anonimizados y sin información personal identificable.
        \item \textbf{Sesgos:} evaluación de desempeño estratificada por subgrupos disponibles y revisión de errores sistemáticos.
